...
img = io.imread("/mnt/europa/valerio/blocco1_GFP.tif")
...
plt.figure(figsize=(20, 20))
ax = plt.gca()
sd1.pl.render_images('fluo_image', cmap = 'grey').pl.show(ax = ax, coordinate_systems="blocco1", save = 'output_python/aligned_sub1.png')
...
#             dims=("y", "x")
# )  
# sdata_im = sdata.aggregate(values="fluo_image", by="rast_nucle", agg_func="mean", target_coordinate_system = 'blocco1')
# 
